 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://wsClientexml/", wsdlLocation = "http://localhost:8080/WebApplication1/NewWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName NEWWEBSERVICE_QNAME = new QName("http://wsClientexml/", "NewWebService");
    ...
    public NewWebService getNewWebServicePort() {
        return super.getPort(new QName("http://wsClientexml/", "NewWebServicePort"), NewWebService.class);
    }
    ...
    public NewWebService getNewWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://wsClientexml/", "NewWebServicePort"), NewWebService.class, features);
    }
